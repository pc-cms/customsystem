/**
 * ClubPokerTipsTab — unified Day/Week/Month/Year/Custom picker.
 */
  ...
  return (
    <PageShell>
      ...
      <PageSection card={false}>
        <TipsLedgerTable rows={rows} emptyMessage="No Club Poker tips in this period" fallbackEmployee="Unknown" />
      </PageSection>
    </PageShell>
  );
}
