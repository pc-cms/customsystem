 ...
 * Never shows monetary amounts — only Allowed / Warning / Need Approval / Unknown.
 * Detailed numbers stay on manager/finance surfaces.
 */
import { Badge } from "@/components/ui/badge";
import { Check, AlertTriangle, ShieldAlert, HelpCircle } from "lucide-react";
