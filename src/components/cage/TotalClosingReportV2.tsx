...
import {
  A4_LAND_CLASS, A4_LAND_STYLE, Card, CardTable, PageFooter, ReportHeader, Signatures, buildReportId, num, signed,
...
const TotalClosingReportV2 = ({
  ...
  return (
    <div className={`${A4_LAND_CLASS} bg-white text-black p-2 flex flex-col`} style={A4_LAND_STYLE}>
