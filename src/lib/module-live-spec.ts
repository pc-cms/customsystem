...
export const MODULE_LIVE_SPEC: Partial<Record<ModuleKey, LiveTableSpec[]>> = {
  ...
  pit_active_players: [
    ...
    { table: "player_day_drop_cache", queryKeyPrefixes: ["total-drop-cache", "players-drop-cache-today", "players-drop-cache-range", "player-drop-cache-by-days", "players-drop-split", "player-drop-split"] },
  ],
  pit_book: [
