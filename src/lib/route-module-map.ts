...
export const moduleKeyForRoute = (to: string, label?: string): ModuleKey | null => {
  ...
  if (base === "/attendance/floor" || base === "/attendance/security" || base === "/attendance/office" || base === "/attendance/management") return "staff_attendance";
  ...
  if (base === "/reports/blanks") return "reports";
  ...
  if (base === "/reports/expenses-matrix") return "report_daily_balance";
  if (base === "/reports/expenses-casino") return "report_daily_balance";
  if (base === "/reports/expenses-office") return "report_daily_balance";
  if (base === "/reports/office-balance") return "report_daily_balance";
  if (base.startsWith("/demo/")) return "report_demo";
