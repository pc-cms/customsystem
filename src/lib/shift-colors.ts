...
export const UNIFIED_SHIFT_TINTS: Record<string, string> = {
  ...
  SW: "bg-violet-200 text-violet-900 dark:bg-violet-700/60 dark:text-white",
  ...
  E: "bg-fuchsia-100 text-fuchsia-700 dark:bg-fuchsia-500/30 dark:text-fuchsia-200",
  EM: "bg-fuchsia-100 text-fuchsia-700 dark:bg-fuchsia-500/30 dark:text-fuchsia-200",
  EN: "bg-fuchsia-100 text-fuchsia-700 dark:bg-fuchsia-500/30 dark:text-fuchsia-200",
  ESW: "bg-fuchsia-100 text-fuchsia-700 dark:bg-fuchsia-500/30 dark:text-fuchsia-200",
  T: "bg-rose-100 text-rose-700 dark:bg-rose-500/30 dark:text-rose-200",
};

/** True if shift code is any Extra variant (legacy E, EM, EN, ESW). */
