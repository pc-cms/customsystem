-- Slots Result canon update: subtract ACE cashless money difference.
-- Live/Monthly: Slots Result = CashDesk Win - Card Balance - Cashless Difference.
...
BEGIN
  ...
  -- ACE cashless money difference per closed day (applied closed periods only).
  ace_cashless AS (
  ...
  --   Slot Result = SUM per closed day of
  --   (cashdesk_win - players_card_balance - cashless_difference), signed.
  dc AS (
