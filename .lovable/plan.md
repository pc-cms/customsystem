...
## Сверка кошельков (что реально есть против макета PDF)

Проверил все кошельки. В макете помещаются не все — вот расхождения и решение:

| Наш кошелёк | В PDF | Решение |
|---|---|---|
| Cash TZS / USD / EUR / GBP / KES | Есть | Без изменений |
| Банки CRDB TZS/USD, NBC TZS/USD | Есть (Bank Accounts) | Без изменений |
| Selcom TZS / USD (учитываются в кассе как банковский канал) | Нет | Добавляем строками в блок Bank Accounts |
| I&M TZS / USD (есть в кошельках, но в кассе не вводятся) | Нет | Показываем в Bank Accounts на итоговой странице; при нуле — строка с прочерком |
| Мобильные: M-Pesa, Tigo Pesa, HaloPesa, Airtel Money | Есть | Без изменений |
| Main Phone (мобильный кошелёк) | Нет | Добавляем 5-й строкой в блок Cashless |
| Safe Live / Safe Slots, WeChat | Нет | Это офисные кошельки, в кассовый отчёт не входят — не добавляем |

То есть блоки Bank Accounts и Cashless в новом макете строятся динамически из справочника кошельков филиала, а не по жёсткому списку из PDF — иначе при добавлении банка отчёт снова отстанет.
