...
Задаётся один раз на выбранную дату (Cage Casino, Cage Office, Bank) и хранится в базе, а не в браузере. До этой даты отчёт пуст, после — строки создаются сами каждый день.
