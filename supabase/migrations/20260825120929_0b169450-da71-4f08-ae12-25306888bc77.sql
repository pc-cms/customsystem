...
BEGIN
  ...
  -- CANON: the slot CASH component of Wallet Expected is CashDesk Win from
  -- fin_day_closing (ACE `win_cashdesk` or manual Day Closing input).
  -- Slots Result / Net Win is the gaming SYSTEM result and is used for
  -- P&L / statistics only — never for wallet reconciliation.
