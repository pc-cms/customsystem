...
BEGIN
  ...
  -- Open cycles only block an actual day close, never a figures-only update
  -- for a day that is already closed (e.g. auto-closed at 08:00).
...
GRANT EXECUTE ON FUNCTION public.close_business_day_with_figures(uuid,numeric,numeric,numeric,numeric,text,numeric,date) TO authenticated;