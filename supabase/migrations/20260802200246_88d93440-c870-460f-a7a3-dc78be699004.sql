...
BEGIN
  ...
  -- Latest FX rate per foreign currency (<= period end). Used for EUR/GBP/KES.
  ...
  -- Collections = real cash leaving the casino (owner withdrawal, CAPEX).
  ...
  -- Transfers = internal moves between our own wallets/casinos, financially neutral.
