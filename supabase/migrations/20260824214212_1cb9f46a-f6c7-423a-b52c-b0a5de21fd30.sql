...
BEGIN
  ...
  -- Deposits stay a reported figure only: they are money held for third parties
  -- and, by decision, have ZERO effect on Cash Position (neither added nor subtracted).
