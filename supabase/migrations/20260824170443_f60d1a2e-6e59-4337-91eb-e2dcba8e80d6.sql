...
BEGIN
  ...
  other_agg AS (
    -- Only REAL income counts here. JP, tips, bonuses, inter-casino transfers,
    -- owner top-ups and investments are plain transactions: they move wallet
    -- balances but are not earned money.
